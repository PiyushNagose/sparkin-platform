            ...
            >
              <Stack direction="row" spacing={1.3} alignItems="center">
                ...
                <Box sx={{ minWidth: 0, flex: 1 }}>
                  ...
                  <Box sx={{ mt: 0.4, display: "inline-flex", px: 0.7, py: 0.15, borderRadius: "999px", bgcolor: "#EEF4FF", color: "#0E56C8", fontSize: "0.58rem", fontWeight: 800, textTransform: "uppercase" }}>
                    {role}
                  </Box>
                </Box>
              </Stack>
