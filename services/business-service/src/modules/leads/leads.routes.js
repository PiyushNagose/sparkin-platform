...
import { assignLeadVendorsSchema, createLeadSchema, updateLeadStatusSchema } from "./leads.schemas.js";
...
leadsRouter.patch("/:leadId/vendors", validate(assignLeadVendorsSchema), asyncHandler(leadsController.assignVendors));
