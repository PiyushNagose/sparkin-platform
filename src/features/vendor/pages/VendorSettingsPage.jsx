...
const PREFS_KEY = "sparkin_vendor_settings";
    ...
    <VendorPageShell>
      ...
      >
        ...
        <SectionCard
          ...
          title="Account"
          subtitle="Your identity and business profile are managed from the Profile page."
        >
          <Stack spacing={1.05}>
            {[
        ...
        >
          <Typography
            sx={{ color: "#5E6A7D", fontSize: "0.78rem", lineHeight: 1.7 }}
          >
            Your session is managed with access and refresh tokens. Logging out
